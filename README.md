# C++ lightweight client SDK for LiveKit

<!--BEGIN_DESCRIPTION-->
Use this SDK to add collaboration with LiveKit SFU to your C++ app. By connecting to <a href="https://livekit.io/">LiveKit</a> Cloud or a self-hosted server, you can quickly build applications such as multi-modal AI, live streaming, or video calls with just a few lines of code.
<!--END_DESCRIPTION-->
