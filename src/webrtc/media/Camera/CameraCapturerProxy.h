...
{
    using SinksList = std::unordered_set<CameraCapturerProxySink*>;
public:
...
private:
    ...
    Bricks::SafeObj<SinksList> _sinks;
    Bricks::SafeObj<std::optional<webrtc::VideoCaptureCapability>> _activeCapability;
};
