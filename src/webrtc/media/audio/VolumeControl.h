...
public:
    ...
    VolumeControl(uint32_t volume, uint32_t minVolume, uint32_t maxVolume);
    explicit VolumeControl(double volume, uint32_t minVolume, uint32_t maxVolume);
    ...
    VolumeControl& operator = (VolumeControl&&) = default;
private:
