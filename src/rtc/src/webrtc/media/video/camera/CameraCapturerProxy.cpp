...
CameraCapturerProxy::CameraCapturerProxy(webrtc::scoped_refptr<CameraCapturer> impl)
    : _impl(std::move(impl))
{
...
std::shared_ptr<CameraCapturerProxy> CameraCapturerProxy::create(webrtc::scoped_refptr<CameraCapturer> impl)
{
